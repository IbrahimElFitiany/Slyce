...
namespace Customers.Infrastructure.Migrations
{
    ...
    [Migration("20260518202804_AddCustomerAllergensAndDietPreferences")]
    partial class AddCustomerAllergensAndDietPreferences
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Customers.Domain.Entities.Customer", b =>
                {
                    ...
                    b.PrimitiveCollection<List<Guid>>("_allergens")
                        .IsRequired()
                        .HasColumnType("uuid[]")
                        .HasColumnName("allergen_ids");

                    b.PrimitiveCollection<List<Guid>>("_dietPreferences")
                        .IsRequired()
                        .HasColumnType("uuid[]")
