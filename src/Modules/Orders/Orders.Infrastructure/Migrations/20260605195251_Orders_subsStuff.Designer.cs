...
namespace Orders.Infrastructure.Migrations
{
    ...
    [Migration("20260605195251_Orders_subsStuff")]
    partial class Orders_subsStuff
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Orders.Domain.Aggregates.Order.Order", b =>
                {
                    ...
                    b.OwnsOne("Shared.Domain.ValueObjects.DeliveryTimeFrame", "DeliveryTimeFrame", b1 =>
                        {
                            b1.Property<Guid>("OrderId")
                                .HasColumnType("uuid");
                            ...
                            b1.Property<TimeOnly>("From")
                                ...
                                .HasColumnName("DeliveryTimeFrame_From");

                            b1.Property<TimeOnly>("To")
                                .HasColumnType("time without time zone")
                                .HasColumnName("DeliveryTimeFrame_To");
                    ...
                    b.Navigation("DeliveryTimeFrame");
